...
%****** Need to check again with eric and derrick abut inputs here!!!!!
...
\noindent Correctness:
\[
\forall SingleState; DoubleState; DoubleState'; DoubleInputs?@ \pre DoSomeBusiness \land R \land\\
 \t6 DoSomeDoubleBusiness \implies \exists SingleState'; SingleInputs?  @ R' \land DoSomeBusiness
\]
...
Finally correctness. As we saw, the precondition for $DoSomeBusiness$ is true so correctness in this case is the slightly simpler statement
\[
\forall SingleState; DoubleState; DoubleState'; DoubleInputs? @ R \land DoSomeDoubleBusiness \implies\\
